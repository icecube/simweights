...
filelist = {
    ...
    "genie": [
        ("/data/sim/IceCubeUpgrade/genie/step3/141828/upgrade_genie_step3_141828_000000.i3.zst", True),
        (
            "/data/sim/IceCube/2023/generated/GENIE/22590/0000000-0000999/GENIE_NuMu_IceCubeUpgrade_v58.22590.000000.i3.zst",
            True,
        ),
        ("/data/ana/Software/simweights/test-data/genie_numu_volume_scaling.i3.zst", True),
        ("/data/ana/Software/simweights/test-data/genie-icetray.140000A_000000.i3.zst", True),
        ("/data/ana/Software/simweights/test-data/genie-icetray.140000B_000000.i3.zst", True),
        ("/data/ana/Software/simweights/test-data/genie-icetray.140000C_000000.i3.zst", True),
        ("/data/ana/Software/simweights/test-data/genie-icetray.140000D_000000.i3.zst", True),
        ("/data/ana/Software/simweights/test-data/level2_genie-icetray.140000_000000.i3.zst", True),
    ],
}
keys = {
    "corsika": [
...
for simtype, (filename, split) in ((i, x) for i in filelist for x in filelist[i]):
