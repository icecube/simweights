...
class TestTriggeredCorsikaWeighter(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.flux_model = lambda cls, E, pdgid: 1 / cls.etendue
    ...
    def test_h5py(self):
        ...
        wf = simweights.TriggeredCorsikaWeighter(simfile)
    ...
    def test_addition(self):
        ...
        wf2 = simweights.TriggeredCorsikaWeighter(simfile2)
        wf = wf1 + wf2
        self.check_weights(wf)
