...
class Hoerandel(CosmicRayFlux):
    ...
    """
    ptypes = [ p.PPlus, p.He4Nucleus,  p.Li7Nucleus,  p.Be9Nucleus,  p.B11Nucleus,  p.C12Nucleus,  p.N14Nucleus,   
         p.O16Nucleus,  p.F19Nucleus,  p.Ne20Nucleus, p.Na23Nucleus, p.Mg24Nucleus, p.Al27Nucleus, p.Si28Nucleus, 
         p.P31Nucleus,  p.S32Nucleus,  p.Cl35Nucleus, p.Ar40Nucleus, p.K39Nucleus,  p.Ca40Nucleus, p.Sc45Nucleus, 
         p.Ti48Nucleus, p.V51Nucleus,  p.Cr52Nucleus, p.Mn55Nucleus, p.Fe56Nucleus ]
    _funcs = [
...
class GaisserHillas(CosmicRayFlux):
    ...
    `icecube/201102004-v2 <https://internal-apps.icecube.wisc.edu/reports/details.php?type=report&id=icecube%2F201102004>`_
    (2011).
...
class GaisserH3a(CosmicRayFlux):
    ...
    ptypes = [p.PPlus, p.He4Nucleus, p.N14Nucleus, p.Al27Nucleus, p.Fe56Nucleus]
    _funcs = [
        lambda E: 7860*E**-2.66*exp(-E/(4e6* 1))+20.0*E**-2.4*exp(-E/(3e7* 1))+1.70*E**-2.4*exp(-E/(2e9*1)),
        lambda E: 3550*E**-2.58*exp(-E/(4e6* 2))+20.0*E**-2.4*exp(-E/(3e7* 2))+1.70*E**-2.4*exp(-E/(2e9*2)),
        lambda E: 2200*E**-2.63*exp(-E/(4e6* 7))+13.4*E**-2.4*exp(-E/(3e7* 7))+1.14*E**-2.4*exp(-E/(2e9*7)),
        lambda E: 1430*E**-2.67*exp(-E/(4e6*13))+13.4*E**-2.4*exp(-E/(3e7*13))+1.14*E**-2.4*exp(-E/(2e9*13)),
        lambda E: 2120*E**-2.63*exp(-E/(4e6*26))+13.4*E**-2.4*exp(-E/(3e7*26))+1.14*E**-2.4*exp(-E/(2e9*26))]
...
class TIG1996(CosmicRayFlux):
    ...
    M. Thunman, G. Ingelman, P. Gondolo, "Charm Production and High Energy Atmospheric Muon and Neutrino Fluxes,"
...
class GlobalFitGST(CosmicRayFlux):
    ...
    T. K. Gaisser, T. Stanev, and S. Tilav, "Cosmic ray energy spectrum from measurements of air showers,"
